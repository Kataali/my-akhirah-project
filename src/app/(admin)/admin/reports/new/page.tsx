...
async function createReport(formData: FormData) {
  ...
  if (campaign_id) {
    ...
    if (
      ...
      throw new Error(
        "Impact reports can only be created for funded campaigns.",
      );
    }
  }

  // Parse photos_urls (newline or comma separated)
    ...
    <div className="max-w-2xl">
      <div className="mb-8">
        ...
        <p className="text-earth-500 text-sm mt-1">
          Document the real-world impact of a completed campaign.
        </p>
      </div>
      ...
      <form action={createReport} className="card p-7 space-y-5">
        <div>
          ...
          <select
            ...
            required
            className="input"
            defaultValue={searchParams.campaign_id ?? ""}
          >
