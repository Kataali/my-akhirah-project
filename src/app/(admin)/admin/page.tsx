    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-earth-500 text-sm mt-1">
          Welcome back. Here's a snapshot of My Akhira Foundation.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {stats.map(({ icon: Icon, label, value, href, color }) => (
          ...
          >
            ...
            <p className="font-display text-2xl font-bold text-earth-900">
              {value}
            </p>
      ...
      <div className="card overflow-hidden">
        ...
        <div className="divide-y divide-earth-50">
          {recentContributions && recentContributions.length > 0 ? (
                ...
                >
                  <div>
                    <p className="text-earth-700 font-medium">
                      {c.anonymous
                        ? "Anonymous"
                        : (prof?.full_name ?? prof?.email ?? "Investor")}
                    </p>
            ...
            <div className="px-5 py-8 text-sm text-earth-400 text-center">
